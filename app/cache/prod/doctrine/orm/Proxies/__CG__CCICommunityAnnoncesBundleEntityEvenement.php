...
namespace Proxies\__CG__\CCICommunity\AnnoncesBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Evenement extends \CCICommunity\AnnoncesBundle\Entity\Evenement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CCICommunity\\AnnoncesBundle\\Entity\\Evenement' . "\0" . 'id', '' . "\0" . 'CCICommunity\\AnnoncesBundle\\Entity\\Evenement' . "\0" . 'titre', '' . "\0" . 'CCICommunity\\AnnoncesBundle\\Entity\\Evenement' . "\0" . 'texte', '' . "\0" . 'CCICommunity\\AnnoncesBundle\\Entity\\Evenement' . "\0" . 'image', '' . "\0" . 'CCICommunity\\AnnoncesBundle\\Entity\\Evenement' . "\0" . 'auteur', '' . "\0" . 'CCICommunity\\AnnoncesBundle\\Entity\\Evenement' . "\0" . 'date', '' . "\0" . 'CCICommunity\\AnnoncesBundle\\Entity\\Evenement' . "\0" . 'adresse');
        }
