...
namespace Proxies\__CG__\CCICommunity\ConseilBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Adresses extends \CCICommunity\ConseilBundle\Entity\Adresses implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CCICommunity\\ConseilBundle\\Entity\\Adresses' . "\0" . 'id', '' . "\0" . 'CCICommunity\\ConseilBundle\\Entity\\Adresses' . "\0" . 'titre', '' . "\0" . 'CCICommunity\\ConseilBundle\\Entity\\Adresses' . "\0" . 'texte', '' . "\0" . 'CCICommunity\\ConseilBundle\\Entity\\Adresses' . "\0" . 'image', '' . "\0" . 'CCICommunity\\ConseilBundle\\Entity\\Adresses' . "\0" . 'auteur', '' . "\0" . 'CCICommunity\\ConseilBundle\\Entity\\Adresses' . "\0" . 'date', '' . "\0" . 'CCICommunity\\ConseilBundle\\Entity\\Adresses' . "\0" . 'note', '' . "\0" . 'CCICommunity\\ConseilBundle\\Entity\\Adresses' . "\0" . 'adresse');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Adresses $proxy) {
